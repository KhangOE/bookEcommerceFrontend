...
export const Header = (props) => {
  ...
  return (
    <>
      <div
        style={{ fontFamily: "nunito", zIndex: 100 }}
        class="z-100 h-[60px] shadow-md fixed bg-white w-full border-b border-gray-300 lg:px-12 px-4 flex justify-between py-4 items-center"
      >
        <span
          class="material-symbols-outlined lg:hidden cursor-pointer"
          onClick={() => {
        ...
        <div className="flex flex-row items-center h-full gap-16">
          <img alt="a" className="h-[70px] hidden lg:block" src={logo}></img>
        ...
        <div className="flex flex-row items-center gap-8">
          ...
          <span
            class={`material-symbols-outlined cursor-pointer lg:block ${
              search ? "hidden " : ""
            }`}
            onClick={onClick}
          >
